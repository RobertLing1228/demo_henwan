                            ...
                            <div class="mb-4">
                                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                    ...
                                    <div class="flex -space-x-2">
                                        <a href="#" class="">
                                            <img class="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/1.jpg" alt="Guy"/>
                                        </a>
                                        <a href="#" class="">
                                            <img class="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/2.jpeg" alt="Max"/>
                                        </a>
                                        <a href="#" class="">
                                            <img class="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/3.jpg" alt="Charles"/>
                                        </a>
                                        <a href="#" class="">
                                            <img class="inline-block object-cover w-10 h-10 rounded-full ring-2 ring-white" src="/images/person/4.jpg" alt="Jade"/>
                                        </a>
                                    </div>
                            ...
                            <div class="mb-4">
                                <div class="w-full p-4 bg-white shadow-lg rounded-2xl dark:bg-gray-700">
                                    ...
                                    <ul>
                                        ...
                                        <li class="flex items-center my-6 space-x-2">
                                            <a href="#" class="relative block">
                                                <img alt="profil" src="/images/person/5.jpg" class="object-cover w-10 h-10 mx-auto rounded-full "/>
                                            </a>
                                            <div class="flex flex-col">
                                                <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white">
                                                    Marie Lou
                                        ...
                                        <li class="flex items-center my-6 space-x-2">
                                            <a href="#" class="relative block">
                                                <img alt="profil" src="/images/person/6.jpg" class="object-cover w-10 h-10 mx-auto rounded-full "/>
                                            </a>
                                            <div class="flex flex-col">
                                                <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white">
                                                    Ivan Buck
                                        ...
                                        <li class="flex items-center my-6 space-x-2">
                                            <a href="#" class="relative block">
                                                <img alt="profil" src="/images/person/7.jpg" class="object-cover w-10 h-10 mx-auto rounded-full "/>
                                            </a>
                                            <div class="flex flex-col">
                                                <span class="ml-2 text-sm font-semibold text-gray-900 dark:text-white">
                                                    Marina Farga
